...
cd ${DIR}/vendor/FontPatcher &&
  ...
  # fontforge -script font-patcher --makegroups --complete ${DIR}/trulle-mono-normalboldupright.ttf &&
  cp TrulleMonoNerdFont-Bold.ttf ${DIR}/ &&
  open -a Font\ Book ${DIR}/TrulleMonoNerdFont-Bold.ttf
