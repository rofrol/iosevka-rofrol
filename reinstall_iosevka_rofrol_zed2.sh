...
ln -sf ${DIR}/private-build-plans.toml ${DIR}/vendor/Iosevka/private-build-plans.toml &&
	...
	ls ${DIR}/vendor/Iosevka/dist/iosevka-rofrol-zed2/TTF-Unhinted/ &&
	...
	fontforge -script font-patcher --makegroups --complete ${DIR}/vendor/Iosevka/dist/iosevka-rofrol-zed2/TTF-Unhinted/iosevka-rofrol-zed2-Extended.ttf &&
	cp IosevkaRofrolZed2NerdFont-Extended.ttf ${DIR}/ &&
	open -a Font\ Book ${DIR}/IosevkaRofrolZed2NerdFont-Extended.ttf
